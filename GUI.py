...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_num.setGeometry(QtCore.QRect(580, 130, 101, 41))
        self.label_num.setObjectName("label_num")
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(570, 300, 211, 51))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(570, 600, 211, 51))
        self.pushButton_3.setObjectName("pushButton_3")
        self.pushButton_4 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_4.setGeometry(QtCore.QRect(570, 660, 211, 51))
        self.pushButton_4.setObjectName("pushButton_4")
        self.pushButton_5 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_5.setGeometry(QtCore.QRect(570, 240, 211, 51))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Подсчитать конечный вес"))
        self.label.setText(_translate("MainWindow", "Номер"))
        self.pushButton.setText(_translate("MainWindow", "Проверка номера"))
        self.pushButton_3.setText(_translate("MainWindow", "Проверить весы"))
        self.pushButton_4.setText(_translate("MainWindow", "Перезапустить камеру"))
        self.pushButton_5.setText(_translate("MainWindow","Подсчитать начальный вес"))
